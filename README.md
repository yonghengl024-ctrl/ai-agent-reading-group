...
本仓库用于系统介绍 AI-Agent 的核心概念、工具使用、工作流设计和典型实践场景，整理了章节教材链接、讲解视频、PPT/PDF、实践笔记、讨论问题和延伸阅读。
...
| [章节资料](#内容导航) | 按主题浏览教材、视频、PPT 和实践笔记 |
...
- **PPT/PDF**：每章讲解材料，建议优先上传 PDF，必要时同时保留 PPTX。
...
4. 在对应章节的 `README.md` 中补充讲解人、日期和 PPT 链接。
...
本仓库资料仅用于教学、科研和非商业学习交流。教材内容请以原教材网站为准；PPT、视频和笔记等资料由相关讲解人整理或提供，引用、转载或二次使用时请尊重原教材、原作者和讲解人的版权。
